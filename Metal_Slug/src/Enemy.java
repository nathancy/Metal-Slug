...
public class Enemy {
	...
	private final int HALFX = MAPXLENGTH/2;			//Half X length
	...
	//Move speed can only be 1 or 2
	private int ENEMYMOVESPEED =1;
	private EZSound sound;							//Enemy death sound
	private EZImage picture;						//Alive picture
	private EZImage death;							//Death picture
	private String type;							//Enemy type
	private static int deathcounter = 0;
	
	private boolean alive_or_dead;						//State of unit
